            ...
            <div class="container">
                ...
                <nav class="hero-breadcrumb" aria-label="breadcrumb">
                    <ol class="breadcrumb flex-wrap">
                        ...
                        @else    
                            <li class="breadcrumb-item active"><a href="{{ route('gemini.index') }}">Kamus Medis</a></li>
                        @endif
                    </ol>
                </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="search-box d-flex align-items-center gap-2">
                            ...
                            <form action="{{ route('gemini.index') }}" method="GET" id="glossarySearchForm" role="search" autocomplete="off" class="d-flex w-100 align-items-center gap-2">
                                <input
                                    type="text"
                                    id="glossarySearchInput"
                                    name="q"
                                ...
                                >
                                @if(request('q'))
                                    <a href="{{ route('gemini.index') }}" id="resetSearchBtn" class="btn btn-outline-danger">
                                        Reset
                                    </a>
                                @else
                        ...
                        <div class="letter-panel-label">Find diseases &amp; conditions by first letter</div>
                            <div class="letter-grid">
                                ...
                                @foreach(range('A', 'Z') as $letter)
                                    ...
                                    <a href="{{ $hasItems ? route('gemini.index', ['letter' => $letter]) : '#' }}"
                                    class="letter-btn
                                    ...
                                    @foreach($glossary as $prefix => $items)
                                        ...
                                        @foreach($items as $item)
                                            <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                                <a href="{{ route('gemini.show', $item['slug']) }}"
