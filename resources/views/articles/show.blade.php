...
<html lang="en">
    <head>
        ...
        <title>{{ $article['title'] }} - RS St. Elisabeth Semarang</title>
                    ...
                    <div class="col-lg-10">
                        <div class="article-header text-center">
                            <div class="article-meta justify-content-center">
                                <span><i class="fa-regular fa-calendar me-2"></i> {{ \Carbon\Carbon::parse($article['date'])->translatedFormat('d F Y') }}</span>
